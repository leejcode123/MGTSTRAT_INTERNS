...
$(document).on(
    ...
    function () {
        ...
        $("#ef_LeadconsultantHf").each(function () {
            ...
            $("#ec_LeadconsultantNoh").val($("#ef_LeadconsultantNoc").val());
        ...
        $("#leadTotal").html(currency.format(Math.ceil(sum123)));
