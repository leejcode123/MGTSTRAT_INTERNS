                ...
                <div class="form-group position-relative has-icon-left">
                    <fieldset>
                        <select class="form-select engagement-cost @error('ec_sales') is-invalid @enderror"
                            ...
                            <optgroup>
                                <option value="0" {{ $data[0]->ec_sales == '0' ? 'selected="selected"' : '' }}>0%
                                </option>
                            </optgroup>

                            <optgroup label="For large engagements, with EMs:">
                                <option value="4" {{ $data[0]->ec_sales == '4' ? 'selected="selected"' : '' }}>4%
                                </option>
                                <option value="6" {{ $data[0]->ec_sales == '6' ? 'selected="selected"' : '' }}>6%
                                </option>
                            </optgroup>

                            <optgroup label="For regular engagements:">
                                <option value="5" {{ $data[0]->ec_sales == '5' ? 'selected="selected"' : '' }}>5%
                                </option>
                                <option value="7" {{ $data[0]->ec_sales == '7' ? 'selected="selected"' : '' }}>7%
                                </option>
                            </optgroup>
                ...
                <div class="form-group position-relative has-icon-left">
                    <fieldset>
                        <select class="form-select engagement-cost @error('ec_engagementManager') is-invalid @enderror"
                            ...
                            <option value="0"
                                {{ $data[0]->ec_engagementManager == '0' ? 'selected="selected"' : '' }}>
                                0%</option>
                            <option value="2"
                                {{ $data[0]->ec_engagementManager == '2' ? 'selected="selected"' : '' }}>
                                2%</option>
                            <option value="3"
                                {{ $data[0]->ec_engagementManager == '3' ? 'selected="selected"' : '' }}>
                                3%</option>
                            <option value="4"
                                {{ $data[0]->ec_engagementManager == '4' ? 'selected="selected"' : '' }}>
                                4%</option>
                        </select>
                        <div class="form-control-icon">
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control custom-fee @error('ec_customFee') is-invalid @enderror"
                            value="{{ $data[0]->ec_customFee }}" placeholder="Enter Number of Sessions"
                        ...
                        <fieldset class="form-group">
                            <select
                                ...
                                <option value="0" {{ $data[0]->ec_creatorsFee == '0' ? 'selected="selected"' : '' }}>
                                    &#8369;0</option>
                                <option value="500"
                                    {{ $data[0]->ec_creatorsFee == '500' ? 'selected="selected"' : '' }}>
                                    &#8369;500</option>
                                <option value="1000"
                                    {{ $data[0]->ec_creatorsFee == '1000' ? 'selected="selected"' : '' }}>
                                    &#8369;1,000</option>
                            </select>
                            <div class="form-control-icon">
                    ...
                    <div class="form-group position-relative has-icon-left">
                        <fieldset>
                            <input type="text"
                                ...
                                name="creators_hours" value="{{ $data[0]->creators_hours }}" id="creators-hours"
                                onkeyup="myFunction()">
                            <div class="form-control-icon">
                                <i class="fa-solid fa-hourglass-start"></i>
                            </div>
        ...
        <div class="form-group row">
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control lead-hour @error('lead_hours') is-invalid @enderror"
                            name="lead_hours" value="{{ $data[0]->lead_hours }}" id="lead-hours">
                        <div class="form-control-icon">
                            <i class="fa-solid fa-hourglass-start"></i>
                        </div>
                        @error('lead_hours')
            ...
            <div class="col-md-3">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number"
                            class="form-control lead-nonovertime  @error('lead_nonovertime') is-invalid @enderror"
                            name="lead_nonovertime" value="{{ $data[0]->lead_nonovertime }}" id="lead-nonovertime">
                        <div class="form-control-icon">
                    ...
                    <div class="position-relative">
                        <fieldset class="form-group">
                            <select
                                ...
                                <option value="750"
                                    {{ $data[0]->ec_moderator == '750' ? 'selected="selected"' : '' }}>
                                    &#8369;750</option>
                                <option value="1000"
                                    {{ $data[0]->ec_moderator == '1000' ? 'selected="selected"' : '' }}>
                                    &#8369;1,000</option>
                                <option value="1250"
                                    {{ $data[0]->ec_moderator == '1250' ? 'selected="selected"' : '' }}>
                                    &#8369;1,250</option>
                            </select>
                            <div class="form-control-icon">
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number"
                            ...
                            name="moderator_hour" value="{{ $data[0]->moderator_hour }}" id="moderator-hour">
                        <div class="form-control-icon">
                            <i class="fa-solid fa-hourglass-start"></i>
                        </div>
                    </div>
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="form-group position-relative has-icon-left">
                        <input type="number"
                            ...
                            name="moderator_nonovertime" value="{{ $data[0]->moderator_nonovertime }}"
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number"
                            ...
                            value="{{ $data[0]->ec_producer }}" placeholder="" id="ec-producer" name="ec_producer">
                        <div class="form-control-icon">
                    ...
                    <div class="form-group position-relative has-icon-left">
                        <fieldset>
                            <input type="text"
                                ...
                                name="producer_hour" value="{{ $data[0]->producer_hour }}" id="producer-hour">
                            <div class="form-control-icon">
                                <i class="fa-solid fa-hourglass-start"></i>
                            </div>
                        </fieldset>
            ...
            <div class="col-md-3">
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <fieldset>
                            <input type="text"
                                class="form-control producer-nonovertime "
                                name="producer_nonovertime" value="{{ $data[0]->producer_nonovertime }}"
