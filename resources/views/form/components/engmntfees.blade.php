            ...
            <div class="form-group position-relative has-icon-left">
                <fieldset>
                    <select class="form-select engagement-fee @error('ef_customFee') is-invalid @enderror select"
                        ...
                        <option selected disabled>-- Select Customization Fee --</option>
                ...
                <div class="position-relative">
                    <fieldset class="form-group" id="packagePrice123">
                        <select class="form-select program-price @error('ef_programCost') is-invalid @enderror select"
                            ...
                            <option value="old('ef_programCost')" selected disabled>{{ old('ef_programCost') }}</option>
                        </select>
                        <div class="form-control-icon">
            ...
            <div class="form-group has-icon-left">
                ...
                <div class="position-relative">
                    <input type="number" class="form-control working-days @error('ef_workingDays') is-invalid @enderror"
                        value="{{ old('ef_workingDayss') }}" placeholder="---" id="ef-workingDays"
                        name="ef_workingDays">
                    <div class="form-control-icon">
                        <i class="bi bi-calendar4-week"></i>
                    </div>
                    ...
                    <div class="position-relative">
                        <div class="input-group">
                            <input type="text" class="form-control @error('ef_discount') is-invalid @enderror"
                                name="ef_discount" value="{{ old('ef_discount') }}" id="disc"
    ...
    <div class="form-group row">
        <div class="col-md-3">
            <div class="form-group has-icon-left">
                ...
                <div class="position-relative">
                    <input type="text" id="tot" name="ef_total" value="{{ old('ef_total') }}"
