                ...
                <div class="form-group position-relative has-icon-left">
                    <fieldset>
                        <select class="form-select engagement-cost @error('ec_sales') is-invalid @enderror"
                            ...
                            <optgroup>
                                <option value="0" {{ old('ec_sales') == '0' ? 'selected="selected"' : '' }}>0% </option>
                            </optgroup>

                            <optgroup label="For large engagements, with EMs:">
                                <option value="4" {{ old('ec_sales') == '4' ? 'selected="selected"' : '' }}>4% </option>
                                <option value="6" {{ old('ec_sales') == '6' ? 'selected="selected"' : '' }}>6% </option>
                            </optgroup>

                            <optgroup label="For regular engagements:">
                                <option value="5" {{ old('ec_sales') == '5' ? 'selected="selected"' : '' }}>5% </option>
                                <option value="7" {{ old('ec_sales') == '7' ? 'selected="selected"' : '' }}>7% </option>
                            </optgroup>
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control custom-fee @error('ec_customFee') is-invalid @enderror"
                            value="{{ old('ec_customFee') }}" placeholder="Enter Number of Sessions" id="ec-customFee"
                            name="ec_customFee">
                        {{-- <div class="form-control-icon">
                    ...
                    <div class="position-relative">
                        <fieldset class="form-group">
                            <select class="form-select creators-fees @error('ec_creatorsFee') is-invalid @enderror select"
                                ...
                                <option value="0">
                                    &#8369;0</option>
                                <option value="500" {{ old('ec_creatorsFee') == '500' ? 'selected="selected"' : '' }}>
                                    &#8369;500</option>
                                <option value="1000" {{ old('ec_creatorsFee') == '1000' ? 'selected="selected"' : '' }}>
                                    &#8369;1,000</option>
                            </select>
                            {{-- <div class="form-control-icon">
                    ...
                    <div class="form-group position-relative has-icon-left">
                        <fieldset>
                            <input type="text" class="form-control creator-hour @error('creators_hours') is-invalid @enderror" name="creators_hours"
                                value="{{ old('creators_hours')}}" id="creators-hours" onkeyup="myFunction()">
                            {{-- <div class="form-control-icon">
                            <i class="fa-solid fa-cubes"></i>
                        </div> --}}
                        ...
                        <fieldset class="form-group">
                            <select class="form-select program-moderator @error('ec_moderator') is-invalid @enderror select"
                                ...
                                <option value="750" {{ old('ec_moderator') == '750' ? 'selected="selected"' : '' }}>
                                    &#8369;750</option>
                                <option value="1000" {{ old('ec_moderator') == '1000' ? 'selected="selected"' : '' }}>
                                    &#8369;1,000</option>
                                <option value="1250" {{ old('ec_moderator') == '1250' ? 'selected="selected"' : '' }}>
                                    &#8369;1,250</option>
                            </select>
                            {{-- <div class="form-control-icon">
                            <i class="bi bi-person-video2"></i>
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control program-producer @error('ec_producer') is-invalid @enderror"
                            value="{{ old('ec_producer') }}" placeholder="" id="ec-producer"
                            name="ec_producer">
                        {{-- <div class="form-control-icon">
                        <i class="bi bi-calendar4-week"></i>
                    </div> --}}
                ...
                <div class="form-group has-icon-left">
                    ...
                    <div class="form-group position-relative has-icon-left">
                        <fieldset>
                            ...
                            value="{{ old('producer_nonovertime') }}" id="producer-nonovertime">
                            {{-- <div class="form-control-icon">
                            <i class="fa-solid fa-cubes"></i>
                        </div> --}}
