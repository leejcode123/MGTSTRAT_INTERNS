...
class CreateFormResponses1Table extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('form_responses_1', function (Blueprint $table) {
            ...
            $table->string('who_are_you_evaluating', 50)->nullable($value = true);
            ...
            $table->string('what_are_2_3_things_i_did_well', 50)->nullable($value = true);
            $table->string('what_are_2_3_things_i_can_do_better_as_a_mod', 50)->nullable($value = true);
            $table->string('name_of_moderator', 50)->nullable($value = true);
