...
class CreateCobarrubiasDaxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Schema::create('cobarrubias_dax', function (Blueprint $table) {
        //     $table->id();
        //     $table->timestamps();
        // });
        Schema::create('cobarrubias_dax', function (Blueprint $table) {
            ...
            $table->string('signed', 20)->nullable($value = true);
    ...
    {
        Schema::dropIfExists('cobarrubias_dax');
    }
}
