...
class CreateFormResponsesPpeTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('form_responses_ppe', function (Blueprint $table) {
            ...
            $table->string('name_of_program', 200)->nullable($value = true);
            ...
            $table->string('what_did_the_producer_do_well_throughout_the_program_phases', 500)->nullable($value = true);
            $table->string('other_ways_that_the_producer_could_improve_his_her_performance', 500)->nullable($value = true);
            $table->string('any_other_comments_suggestions', 200)->nullable($value = true);
