/******/ (() => {
  ...
  \**********************************/
        ...
        function () {
            ...
            $(".hf-c13").each(function () {
                ...
                if (
                    ...
                    sum13 +=
                        sum13 *
                        (document.getElementById("ga-only-dropdown").value /
                            100);
                }
                sum += +sum13;
            ...
            $("#ec_AnalystTotal").html(currency.format(Math.ceil(sumAnalyst)));
            $("#ec_SubtotalConsulting").html(currency.format(Math.ceil(sumLeadConsultant+sumAnalyst)));
            ...
            $("#subtotal-coFacilitator").html(
                currency.format(Math.ceil(sum22))
            );
    ...
    $(".hf-c46").val(
        currency.format(Math.ceil(0.85 * $(".hf-c56").val().replace(/,/g, "")))
    );
    ...
    //cluster reference
    document
        .getElementById("cluster-dropdown")
        .addEventListener("change", cluster);
    ...
    function cluster() {
        ...
        if (
            ...
            document.getElementById("input-notListed").disabled = true;
            document.getElementById("input-notListed").style.visibility =
                "hidden";
            document.getElementById("core-valueInput").disabled = true;
